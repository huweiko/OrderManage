...
public class MainActivity extends ActivityGroup
{
	...
	public static final String[] LeiMuArray = {"类别1","类别2","类别3","类别4","类别5","类别6","类别7","类别8","类别9"};
	public static final String[] WareArray = {"材料1","材料2","材料3","材料4","材料5","材料6","材料7","材料8","材料9"};
	...
	private void createView() {
		view = this
				...
				.startActivity("search",
						new Intent(MainActivity.this, CategoryActivity_.class))
				.getDecorView();
		// 用来更改下面button的样式的标志
		view.setTag(0);
		list.add(view);
		view1 = MainActivity.this
				.getLocalActivityManager()
				.startActivity("tuan",
						new Intent(MainActivity.this, OrderActivity_.class))
				.getDecorView();
		view1.setTag(1);
		list.add(view1);
		view2 = MainActivity.this
				.getLocalActivityManager()
				.startActivity("sign",
						new Intent(MainActivity.this, HistoryActivity_.class))
				.getDecorView();
		view2.setTag(2);
		list.add(view2);
	}
