...
public class SearchMoreAdapter extends BaseAdapter {
	...
	private OnSearchOrderElementClickClass onItemClickClass; 
	...
	public void setOrderElementListenr(OnSearchOrderElementClickClass onItemClickClass){
	...
	public interface OnSearchOrderElementClickClass{
	...
	private class OnOptionsClick implements OnClickListener{
		...
		public void onClick(View v) {
			...
			if (onItemClickClass!=null ) {
				onItemClickClass.OnItemClickOrderElement(v, position);
			}
		}
